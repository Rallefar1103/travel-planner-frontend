    ...
    <section id="itineraryForm">
      <div className="left-section">
        ...
        <p className="form-dest-info">
          <span className="bold">First step</span> is to fill in the essentials
          of what city you want to visit, how many hours you expect to spend in
          that city and the budget for your stay.
        </p>

        <p className="form-dining-info">
          <span className="bold">Next step</span> is to tell us something about
          where you'd like to dine for your stay. Fill out the type of cuisine
          you'd like, the type of venue, and lastly the desired price range!
        </p>
